...
public class MainActivity extends AppCompatActivity {
                    ...
                    while ((length = inputStream.read(buf)) != -1)
                    {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                pb.setProgress(tmp/totalLength * 100);
                            }
                        });
                    }
    ...
    public void click3(View v)
    {
        ...
        task.execute("http://www.fhdddd.com/uploads/allimg/131223/1-131223095213.jpg");
    ...
    class MyImageTask extends AsyncTask<String, Integer, Bitmap>
    {
        ...
        protected Bitmap doInBackground(String... strings) {
            ...
            byte[] results = bos.toByteArray();
            Bitmap bmp = BitmapFactory.decodeByteArray(results, 0, results.length);
            return bmp;
        }
    }
}
